(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[53], {
  /***/
  "./node_modules/@carto/airship-components/dist/esm/es5/build/w6zfcvoh.sc.entry.js":
  /*!****************************************************************************************!*\
    !*** ./node_modules/@carto/airship-components/dist/esm/es5/build/w6zfcvoh.sc.entry.js ***!
    \****************************************************************************************/

  /*! exports provided: AsDropdown */

  /***/
  function node_modulesCartoAirshipComponentsDistEsmEs5BuildW6zfcvohScEntryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AsDropdown", function () {
      return Dropdown;
    });
    /* harmony import */
    ...
    var Dropdown = function () {
      function t() {
        var t = this;
        this.options = [], this.selectedOption = null, this.defaultText = "", this.showClearButton = !1, this.isOpen = !1, this.selectedOptionObject = {}, this.onClickOutside = function () {
          t._closeList();
        };
      }

      return t.prototype.closeList = function () {
        return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
          return _polyfills_tslib_js__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (t) {
            return this._closeList(), [2];
          });
        });
      }, t.prototype.onSelectionChanged = function (t) {
        this._selectFromValue(t);
      }, t.prototype.onOptionsChanged = function () {
        this._selectFromValue(this.selectedOption);
      }, t.prototype.onClickOutsideChanged = function (t, e) {
        document.removeEventListener("click", e), document.addEventListener("click", t);
        ...
        var t = this,
            e = this.showClearButton && Boolean(this.selectedOption);
        return Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", {
          class: {
            "as-dropdown": !0,
            "as-dropdown--clear": e,
            "as-dropdown--open": this.isOpen
          }
        }, Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", {
          class: "as-dropdown__control as-body",
          "aria-haspopup": "true",
          "aria-expanded": this.isOpen,
          onClick: function onClick(e) {
            e.stopPropagation(), t._toggleList();
          }
        }, this.selectedOptionObject && this.selectedOptionObject.text || this.selectedOptionObject && this.selectedOptionObject.value || this.defaultText, Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", {
          class: "as-dropdown__arrow"
        }, Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("svg", {
          viewBox: "2 6 12 6",
          xmlns: "http://www.w3.org/2000/svg"
        }, Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("path", {
        ...
        })))), Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ul", {
          tabindex: "-1",
          class: "as-dropdown__list"
        }, this._renderOptions(this.options)), e ? Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", {
          class: "as-dropdown__clear",
          onClick: function onClick() {
            return t.clearOption();
          }
        }, Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("svg", {
          viewBox: "2 2 12 12",
          xmlns: "http://www.w3.org/2000/svg"
      ...
      }, t.prototype._renderOptions = function (t) {
        var e = this;
        return t.map(function (t) {
          var o = {
            "as-body": !0,
            "is-selected": e._isSelected(t)
          };
          return Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("li", {
            class: "as-dropdown__list-item",
            "data-value": t.value
          }, Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", {
            class: o,
            onClick: function onClick(o) {
              o.stopPropagation(), e._select(t);
            }
          }, t.text || t.value));
        });
      }, t.prototype._isSelected = function (t) {
        return t === this.selectedOptionObject;
      }, t.prototype._select = function (t) {
        this.selectedOption !== t.value && (this.selectedOption = t.value, this.selectedOptionObject = t, this._closeList(), this._emitOption());
      }, t.prototype._selectFromValue = function (t) {
        if (null != t) {
          var e = this.options.find(function (e) {
            return e.value === t;
          });
          e && (this.selectedOptionObject = e);
        } else this.selectedOptionObject = null;
      }, t.prototype._toggleList = function () {
        this.isOpen = !this.isOpen;
      }, t.prototype._closeList = function () {
        this.isOpen = !1;
      }, t.prototype.clearOption = function () {
        this._closeList(), this.selectedOption = null, this._emitOption();
      }, t.prototype._emitOption = function () {
