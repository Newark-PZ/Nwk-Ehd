...
export class OrcHomeComponent {
  homePageDetails: HomePage = {
    id: 'home',
    splashImg: {src: 'assets/img/headerPhotos/newarkfall.jpg', alt: 'Newark Skyline'},
    buttonCategories: ['Info'],
    buttons: [
      {
        disabled: true, icon: 'house', category: 'Info', title: 'Rent Control Board', parent: '/rentcontrol', link: 'board'
      },
      {
        disabled: true, icon: 'map', category: 'Info', title: 'Interactive Rent Control Map', parent: '/rentcontrol', link: 'maps'
      },
      {
        disabled: true, icon: 'attachment', category: 'Info', title: 'Documents', parent: '/rentcontrol', link: 'resources'
      }
    ],
    contentIntro: {
