(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[55], {
  /***/
  "./node_modules/@carto/airship-components/dist/esm/es5/build/wubyvvev.sc.entry.js":
  /*!****************************************************************************************!*\
    !*** ./node_modules/@carto/airship-components/dist/esm/es5/build/wubyvvev.sc.entry.js ***!
    \****************************************************************************************/

  /*! exports provided: AsTabs */

  /***/
  function node_modulesCartoAirshipComponentsDistEsmEs5BuildWubyvvevScEntryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AsTabs", function () {
      return Tabs;
    });
    /* harmony import */
    ...
    var _chunk_b0e1ce66_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./chunk-b0e1ce66.js */
    "./node_modules/@carto/airship-components/dist/esm/es5/build/chunk-b0e1ce66.js");

    var Tabs = function () {
      function t() {
        this.activeTab = 0, this.xl = !1;
      }

      return t.prototype.render = function () {
        var t = this._parseChildren();

        return [this._renderTabs(t), Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)];
      }, t.prototype.componentDidLoad = function () {
        var t = this._parseChildren();

        this._updateActiveTab(t);
      }, t.prototype.componentDidUpdate = function () {
        var t = this._parseChildren();

        this._updateActiveTab(t);
      }, t.prototype._parseChildren = function () {
        return Array.from(this.element.querySelectorAll('[role="tabpanel"]'));
      }, t.prototype._updateActiveTab = function (t) {
        var e = this;
        t ? t.forEach(function (t, r) {
          var a = e.activeTab === r;
          a ? t.removeAttribute("hidden") : t.setAttribute("hidden", "hidden"), a && Object(_chunk_b0e1ce66_js__WEBPACK_IMPORTED_MODULE_1__["a"])(t);
        }) : console.warn('Airship Tabs: Children elements must have role="tabpanel" attribute.');
      }, t.prototype._renderTabs = function (t) {
        ...
        }, t.map(this._renderTab.bind(this)));
      }, t.prototype._renderTab = function (t, e) {
        var r = this,
            a = {
          "as-tabs__item": !0,
          "as-tabs__item--active": e === this.activeTab
        },
            i = this._getTitle(t, e);

        return Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", {
          role: "tab",
          class: a,
      ...
      }, t.prototype._getTitle = function (t, e) {
        return t.getAttribute("data-title") ? t.getAttribute("data-title") : "Tab " + e;
