(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[27], {
  /***/
  "./node_modules/@carto/airship-components/dist/esm/es5/build/nycfox15.sc.entry.js":
  /*!****************************************************************************************!*\
    !*** ./node_modules/@carto/airship-components/dist/esm/es5/build/nycfox15.sc.entry.js ***!
    \****************************************************************************************/

  /*! exports provided: AsLegendSizeBinsPoint */

  /***/
  function node_modulesCartoAirshipComponentsDistEsmEs5BuildNycfox15ScEntryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AsLegendSizeBinsPoint", function () {
    ...
    var FAKE_BORDER_SIZE = 1,
      ...
      return e.prototype.render = function () {
        ...
        var i = ((e = {
          "as-legend-size-bins-point--steps": !0
        })["as-legend-size-bins-point--" + this.orientation] = !0, e);
        return this.maxSize = this.width || this.data.slice().sort(function (e, t) {
        ...
        var t = FAKE_BORDER_SIZE + "px " + (e.strokeStyle || "solid") + " " + e.strokeColor,
            i = Object(_chunk_512e386e_js__WEBPACK_IMPORTED_MODULE_1__["a"])(e.strokeStyle) ? 2 * FAKE_BORDER_SIZE : 0,
            n = Math.round(e.width) + i,
            r = n + "px",
            s = (n > this.maxSize ? n : this.maxSize + i) + "px",
            a = this.getMask(e),
            o = {};
        "horizontal" === this.orientation ? o.height = s : "vertical" === this.orientation && (o.width = s);
        var l = Object.assign({
        ...
        return Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "as-legend-size-bins-point--step"
        }, Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          style: o,
          class: "as-legend-size-bins-point--circle-wrapper"
        }, Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "as-legend-size-bins-point--circle",
          style: l
        })), Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", {
          class: "as-legend-size-bins-point--label"
        }, e.label));
      }, e.prototype.getMask = function (e) {
        return e.marker ? {
          "-webkit-mask-image": "url(" + e.marker + ")",
          "-webkit-mask-position": "center",
          "-webkit-mask-repeat": "no-repeat",
          "-webkit-mask-size": e.width + "px",
          maskImage: "url(" + e.marker + ")",
          maskPosition: "center",
