(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[23], {
  /***/
  "./node_modules/@carto/airship-components/dist/esm/es5/build/kcyrxlpo.sc.entry.js":
  /*!****************************************************************************************!*\
    !*** ./node_modules/@carto/airship-components/dist/esm/es5/build/kcyrxlpo.sc.entry.js ***!
    \****************************************************************************************/

  /*! exports provided: AsLegendColorBins, AsLegendColorBinsPolygon */

  /***/
  function node_modulesCartoAirshipComponentsDistEsmEs5BuildKcyrxlpoScEntryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AsLegendColorBins", function () {
      return LegendColorBins;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "AsLegendColorBinsPolygon", function () {
    ...
    var LegendColorBins = function () {
      function e() {}

      return e.prototype.render = function () {
        return this.data && 0 !== this.data.length ? "polygon" === this.data[0].type ? Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("as-legend-color-bins-polygon", {
          data: this.data,
        ...
        get: function get() {
          return "as-legend-color-bins{display:block}";
        },
        enumerable: !0,
        configurable: !0
      }), e;
    }(),
        LegendColorBinsPolygon = function () {
      function e() {
      ...
      return e.prototype.render = function () {
        ...
        var n = ((e = {
          "as-legend-color-bins-polygon--outer-wrapper": !0
        })["as-legend-color-bins-polygon--" + this.orientation] = !0, e);
        return Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          ...
          class: "as-legend-color-bins-polygon--wrapper as-legend-color-bins-polygon--color"
        }, this.data.map(this.renderStep)), Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "as-legend-color-bins-polygon--wrapper as-legend-color-bins-polygon--labels"
        }, this.data.map(this.renderLabels)));
      }, e.prototype.renderStep = function (e) {
        return Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "as-legend-color-bins-polygon--step",
          style: {
            background: e.color
          }
        });
      }, e.prototype.renderLabels = function (e) {
        return Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "as-legend-color-bins-polygon--label"
        }, Object(_airship_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, e.label));
      }, Object.defineProperty(e, "is", {
        get: function get() {
